			...
			<form id="registerForm" method="POST" action="registrarse">
				...
				<div class="inputLine">
					<label class="inputIcon" for="surname"><i
						class="fa fa-list-alt fa-2x"></i></label> <input type="text"
						name="surname" id="surname" class="textInput textInputWithIcon"
				...
				<div class="inputLine">
					<label class="inputIcon" for="user"><i
						class="fa fa-user fa-2x"></i></label> <input type="text" name="user"
						id="user" class="textInput textInputWithIcon"
						placeholder="Usuario">
				</div>
				<div class="inputLine">
